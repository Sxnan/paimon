 ...
 */
public abstract class AbstractSingleFileWriter<T, R> implements SingleFileWriter<T, R> {

    private static final Logger LOG = LoggerFactory.getLogger(AbstractSingleFileWriter.class);
    ...
    public AbstractSingleFileWriter(
            FileIO fileIO,
    ...
    public long getEstimatedDataSize() throws IOException {
        return writer.getEstimatedDataSize();
    }
